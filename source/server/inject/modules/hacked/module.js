 ...
 */
injectify.module('embed', function(embed) {
    embed.setAttribute('srcdoc', '<div class=msg>Hacked!</div><div id=console></div><style>body{margin:0;padding:5vh 5vw;background:#000;overflow:hidden}*{box-sizing:border-box}p{font-family:monospace;font-weight:700;font-size:4.1vh;margin:0;padding:0;line-height:1;color:#32cd32;text-shadow:0 0 10px #32cd32}.msg{font-family:monospace;font-weight:700;text-transform:uppercase;font-size:5vh;padding-top:5vh;background:red;box-shadow:0 0 30px red;text-shadow:0 0 20px #fff;color:#fff;width:20vw;height:15vh;position:absolute;left:50%;margin-left:-10vw;top:50%;margin-top:-5vh;text-align:center;min-width:200px;animation-name:blink;animation-duration:.6s;animation-iteration-count:infinite;animation-direction:alternate;animation-timing-function:linear}@keyframes blink{0%{opacity:0}100%{opacity:1}}</style><script>function updateScreen(){for(txt.push(txt.shift()),txt.forEach(function(t){var e=document.createElement("p");e.textContent=t,docfrag.appendChild(e)});c.firstChild;)c.removeChild(c.firstChild);c.appendChild(docfrag)}var intervalID=window.setInterval(updateScreen,200),c=document.getElementById("console"),txt=["FORCE: XX0022. ENCYPT://000.222.2345","TRYPASS: ********* AUTH CODE: ALPHA GAMMA: 1___ PRIORITY 1","RETRY: REINDEER FLOTILLA","Z:> /FALKEN/GAMES/TICTACTOE/ EXECUTE -PLAYERS 0","================================================","Priority 1 // local / scanning...","scanning ports...","BACKDOOR FOUND (23.45.23.12.00000000)","BACKDOOR FOUND (13.66.23.12.00110000)","BACKDOOR FOUND (13.66.23.12.00110044)","...","...","BRUTE.EXE -r -z","...locating vulnerabilities...","...vulnerabilities found...","MCP/> DEPLOY CLU","SCAN: __ 0100.0000.0554.0080","SCAN: __ 0020.0000.0553.0080","SCAN: __ 0001.0000.0554.0550","SCAN: __ 0012.0000.0553.0030","SCAN: __ 0100.0000.0554.0080","SCAN: __ 0020.0000.0553.0080"],docfrag=document.createDocumentFragment()</script>' )
})
