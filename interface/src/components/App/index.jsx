...
const styles = (theme) => ({
  ...
  appFrameBlue: {
    ...
    boxShadow: ['inset 0px 180px 120px -100px rgb(56, 70, 152)']
  },
  appBar: {
    position: 'absolute',
  ...
  render() {
    ...
    return (
      <div className={`app ${settings.dark ? 'dark' : ''} ${classes.appFrame}`}>
        <div
          className={classNames('main', classes.appFrame, {
          ...
          <AppBar
            className={classNames(classes.appBar, {
              ...
              [classes.transparent]: !account && section === 'home',
              [classes.noShadow]: (!account && section === 'home') || section === 'documentation'
            })}>
            <Toolbar
              disableGutters={this.state.mobile || !drawerOpen}
              classes={{ root: classes.gutters }}>
              <IconButton
                color="inherit"
...
export default connect(
  ({ injectify: { account, section, drawerOpen, settings } }) => ({
    section,
    account,
    drawerOpen,
    settings
