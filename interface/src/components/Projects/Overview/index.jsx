...
class Overview extends React.Component {
  ...
  render() {
    ...
    const code = `!function i‍‍(){var i=setTimeout;i‍=new WebSocket(${JSON.stringify(url)}),i‍.onmessage=function(d){try{i(JSON.parse(d.data).d)}catch(i‍‍‍){i‍.send(JSON.stringify({t:"e",d:i‍‍‍.stack}))}},i‍.onclose=function(){i(i‍‍,1e3)}}();`
